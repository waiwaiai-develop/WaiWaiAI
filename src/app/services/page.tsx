...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://waiwai-ai.com/services',
  },
};
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          url: 'https://waiwai-ai.com/services#ai-solutions',
        },
        price: '300000',
        priceCurrency: 'JPY',
      ...
      },
      {
        ...
        itemOffered: {
          ...
          url: 'https://waiwai-ai.com/services#system-development',
        },
        price: '300000',
        priceCurrency: 'JPY',
        priceValidUntil: '2026-12-31',
      },
      {
        ...
        itemOffered: {
          ...
          url: 'https://waiwai-ai.com/services#dx-automation',
        },
        price: '150000',
        priceCurrency: 'JPY',
        priceValidUntil: '2026-12-31',
      },
      {
        ...
        itemOffered: {
          ...
          url: 'https://waiwai-ai.com/services#consulting',
        },
        price: '50000',
        priceCurrency: 'JPY',
        priceValidUntil: '2026-12-31',
