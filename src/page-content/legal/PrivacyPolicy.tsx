        ...
        <div className="pt-32 pb-24 relative min-h-screen">
            ...
            <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="text-[#5a5a6e] font-medium tracking-widest text-sm">PRIVACY POLICY</p>
                </motion.div>
                ...
                >
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第1条（個人情報）</h2>
                    <p>
                        「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報（個人識別情報）を指します。
                    </p>

                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第2条（個人情報の収集方法）</h2>
                    <p>
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第3条（個人情報を収集・利用する目的）</h2>
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第4条（利用目的の変更）</h2>
                    <p>
                        当社は、利用目的が変更前と関連性を有すると合理的に認められる場合に限り、個人情報の利用目的を変更するものとします。利用目的の変更を行った場合には、変更後の目的について、当社所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。
                    </p>

                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第5条（個人情報の第三者提供）</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第6条（個人情報の安全管理）</h2>
                    <p>
                        当社は、個人情報の正確性および安全性を確保するために、セキュリティに万全の対策を講じるとともに、個人情報の漏えい、滅失またはき損の防止およびその他の個人情報の安全管理のために必要かつ適切な措置を講じます。
                    </p>

                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第7条（個人情報の開示・訂正・削除）</h2>
                    <p>
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第8条（Cookie等の利用）</h2>
                    <p>
                    ...
                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第9条（プライバシーポリシーの変更）</h2>
                    <p>
                        本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく、変更することができるものとします。当社が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。
                    </p>

                    <h2 className="text-lg font-bold text-white mt-10 mb-4 pb-3 border-b border-white/[0.06]">第10条（お問い合わせ窓口）</h2>
                    <p>
