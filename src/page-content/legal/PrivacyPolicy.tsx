        ...
        <div className="pt-32 pb-24 relative min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 md:px-8 max-w-4xl relative z-10">
                ...
                >
                    ...
                    <p className="text-stone-500 font-medium tracking-widest text-sm">PRIVACY POLICY</p>
                </motion.div>
                ...
                >
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第1条（個人情報の定義）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第2条（個人情報の収集方法）</h2>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第3条（個人情報の利用目的）</h2>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第4条（利用目的の変更）</h2>
                    <p>
                        当社は、利用目的が変更前と関連性を有すると合理的に認められる場合に限り、個人情報の利用目的を変更するものとします。利用目的の変更を行った場合には、変更後の目的について、当社所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第5条（個人情報の第三者提供）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第6条（個人情報の委託）</h2>
                    <p>
                        当社は、利用目的の達成に必要な範囲において、個人情報の取扱いの全部または一部を外部に委託する場合があります。この場合、当社は委託先に対し、個人情報の安全管理が図られるよう適切な監督を行います。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第7条（個人情報の安全管理）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第8条（個人情報の開示・訂正・削除）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第9条（Cookie（クッキー）の使用について）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第10条（アクセス解析ツールの使用）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第11条（外部サービスの利用）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第12条（プライバシーポリシーの変更）</h2>
                    <p>
                        本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく変更することができるものとします。変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第13条（お問い合わせ窓口）</h2>
