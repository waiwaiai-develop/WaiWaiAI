        ...
        <div className="pt-32 pb-24 relative min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 md:px-8 max-w-4xl relative z-10">
                ...
                >
                    ...
                    <p className="text-stone-500 font-medium tracking-widest text-sm">TERMS OF SERVICE</p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="bg-white  p-8 md:p-12 border border-stone-200  prose prose-stone max-w-none text-stone-600 leading-loose"
                >
                    <p className="mb-8">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第1条（適用）</h2>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第2条（サービス内容）</h2>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第3条（禁止事項）</h2>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第4条（知的財産権）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第5条（秘密保持）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第6条（本サービスの提供の停止等）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第7条（利用制限および登録抹消）</h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第8条（保証の否認および免責事項）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第9条（損害賠償）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第10条（個人情報の取扱い）</h2>
                    <p>
                        当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第11条（反社会的勢力の排除）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第12条（権利義務の譲渡の禁止）</h2>
                    <p>
                        ユーザーは、当社の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第13条（利用規約の変更）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第14条（分離可能性）</h2>
                    <p>
                        本規約のいずれかの条項またはその一部が、法令等により無効または執行不能と判断された場合であっても、本規約の残りの規定および一部が無効または執行不能と判断された規定の残りの部分は、継続して完全に効力を有するものとします。
                    </p>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第15条（準拠法・管轄裁判所）</h2>
                    <ol className="list-decimal pl-6 space-y-2 mt-4">
                        <li>本規約の解釈にあたっては、日本法を準拠法とします。</li>
                        <li>本サービスに関して紛争が生じた場合には、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</li>
                    </ol>

                    <h2 className="text-xl font-bold text-stone-900 mt-10 mb-4 border-b border-stone-200 pb-2">第16条（お問い合わせ窓口）</h2>
                    <p>本規約に関するお問い合わせは、下記までお願いいたします。</p>
                    <div className="mt-4 p-4 bg-stone-50 rounded-xl">
                        <p className="font-bold text-stone-900">WaiWai AI 株式会社</p>
                        <p>代表取締役：久保田慧</p>
                        <p>メールアドレス：kei.kubota@waiwaiai.com</p>
                    </div>

                    <div className="mt-12 pt-8 border-t border-stone-100 text-sm text-stone-400 font-medium">
                        <p>制定日：2025年1月23日</p>
